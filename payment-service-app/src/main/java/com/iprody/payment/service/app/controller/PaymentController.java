...
public class PaymentController {
    ...
    public Page<PaymentDto> search(
        ...
        Page<PaymentDto> result = paymentService.search(filter, pageRequest);
    ...
    public PaymentDto get(@PathVariable UUID id) {
        ...
        log.debug("Get payment result: id={}, state={}",
                result.getGuid(), result);
        return result;
    }
    ...
    public PaymentDto create(@RequestBody CreatePaymentDto paymentDto)  {
        ...
        log.debug("Create payment result: id={}, state={}",
                result.getGuid(), result);
        return result;
    }
    ...
    public PaymentDto update(@RequestBody PaymentDto paymentDto) {
        ...
        PaymentDto result = paymentService.update(paymentDto.getGuid(), paymentDto);
        log.debug("Update payment result: id={}, state={}",
                result.getGuid(), result);
        return result;
    }
}